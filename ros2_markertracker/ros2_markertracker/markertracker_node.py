...
class ProcessFramePubSub(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("aruco_dictionary_id", "DICT_5X5_50")
        _aruco_dictionary_id = self.get_parameter("aruco_dictionary_id").get_parameter_value().string_value

        self.declare_parameter("path_to_camera_file", "/home/sumedh/px4_ros_com_ros2/src/ros2_markertracker/calibration/iris_fpv_cam_640x480.yaml")
        ...
        # Load camera file
        self.get_logger().info(f'Loading camera file: {"/home/sumedh/px4_ros_com_ros2/src/ros2_markertracker/calibration/iris_fpv_cam_640x480.yaml"}')
        fs = cv2.FileStorage("/home/sumedh/px4_ros_com_ros2/src/ros2_markertracker/calibration/iris_fpv_cam_640x480.yaml", cv2.FILE_STORAGE_READ)
