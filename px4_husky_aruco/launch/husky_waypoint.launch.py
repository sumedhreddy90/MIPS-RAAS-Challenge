...
def generate_launch_description():
    ...
    package_name = 'husky_gazebo'
    pkg_share = FindPackageShare(package=package_name).find(package_name)
    robot_localization_file_path_path = 'config/ekf.yaml'
    robot_localization_file_path = os.path.join(pkg_share, robot_localization_file_path_path)
